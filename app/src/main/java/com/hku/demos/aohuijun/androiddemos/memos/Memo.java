...
public class Memo {
    ...
    public static final String AUTHORITY = "com.example.aohuijun.app.memos.provider";
...
//                                                    _UPDATE_TIME + " VARCHAR(255)" +
    ...
    public static final String ACTION_CREATE_MEMO = "";
    public static final String ACTION_VIEW_MEMO = "";
}
