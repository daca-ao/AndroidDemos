...
/**
 * Created by aohuijun on 16/1/30.
 */
public class MyApp {

    public static final int ENTRY_BASICS = 0;
    ...
    public static final int TEXT_SHARE = 5;
    public static final int APPS_CENTER = 6;
    public static final int SELECTABLE_GRID_VIEW = 7;
